...
## [0.21.1](https://github.com/Cooler1989/atsamd_wio/compare/atsamd-hal-0.21.0...atsamd-hal-0.21.1) - 2025-04-15

### Added

- *(tc)* Add support for TC6/7 on applicable chips ([#835](https://github.com/Cooler1989/atsamd_wio/pull/835))
- Add ehal 1.0 InputPin impl for ExtInt ([#826](https://github.com/Cooler1989/atsamd_wio/pull/826))

### Fixed

- *(tc)* Read syncbusy instead of perbufv ([#840](https://github.com/Cooler1989/atsamd_wio/pull/840))
